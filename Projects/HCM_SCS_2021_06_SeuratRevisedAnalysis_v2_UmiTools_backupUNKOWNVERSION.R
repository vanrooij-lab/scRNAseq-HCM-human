...
if ('loadraw' %in% desired_command) {
    ...
    pryr::object_size(SCS_df_list_data_raw)
        # Note that I've pre-processed the data using the file
        # HCM_SCS_2021_07_preprocessing_counttables_v2b.R
        # Which is where I also add the gene symbol annotation.
