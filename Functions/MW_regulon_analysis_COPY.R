...
# chosen_cutoff_parameter = 'p'; connectedness_cutoff = NULL; max_genes = NULL; show_heatmap=F
...
# hierarchical_cutoff=NULL; KMAX_GAPTEST=20
MW_determine_regulons_part5 = function(regulon_object, hierarchical_cutoff=NULL, KMAX_GAPTEST=20, hierarchical_cutoff_fallback=NULL, BIGB=100) {    
    ...
    if (is.null(hierarchical_cutoff)) {
        ...
        ERROR_FLAG=tryCatch({
            ...
            print('ERROR DETECTED; raising flag')
            ERROR_FLAG=T
            ...
            print('WARNING DETECTED .. ignoring ..')
...
MW_regulon_final_export = function(regulon_object) {
    ...
    openxlsx::write.xlsx(x = output_df, file = paste0(regulon_object$outputDir_sub, 'regulon_analysis_',regulon_object$analysis_name,'.xlsx'), overwrite = T)
